      ...
      <div className="relative z-2 min-h-screen flex">
        ...
        <div className="hidden lg:flex w-[60%] relative items-center justify-center p-12 xl:p-20">
          ...
          <motion.div
            ...
            className="absolute top-16 left-12 w-32 h-32 bg-pink border-[3px] border-ink"
          ...
          <motion.div
            ...
            className="absolute bottom-24 right-16 w-24 h-24 bg-cyan border-[3px] border-ink"
            style={{ boxShadow: '6px 6px 0px #0A0A0A' }}
          />
          <motion.div
            ...
            className="absolute top-40 right-24 w-16 h-16 bg-yellow border-[3px] border-ink"
          ...
          <div className="max-w-xl relative">
            ...
            >
              <h1 className="font-sans font-bold tracking-[-0.04em] leading-[0.92] mb-6"
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <span className="absolute bottom-1 left-0 w-full h-[40%] bg-cyan z-0" />
                </span>
              </h1>
            </motion.div>

            {/* Tagline in handwritten font */}
            <motion.p
            ...
            <motion.div
              ...
              className="absolute -bottom-16 right-0 font-hand text-xl text-pink"
            ...
            <div className="bg-[#1c1b1b] border-[3px] border-paper p-8 sm:p-10"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div
                      ...
                      className={`w-5 h-5 border-[3px] border-paper flex items-center justify-center transition-all cursor-pointer ${
                        rememberMe ? 'bg-yellow border-yellow' : 'bg-transparent'
                      }`}
                    >
                      {rememberMe && (
                        <svg width="12" height="10" viewBox="0 0 12 10" fill="none">
                          <path d="M1 5L4.5 8.5L11 1" stroke="#0A0A0A" strokeWidth="2.5" strokeLinecap="square" />
                        </svg>
                      )}
                    </div>
                    <span className="font-mono text-xs text-[#cec6ac] group-hover:text-paper transition-colors">
                      REMEMBER ME
                    </span>
                  </label>
                  <Link to="/forgot-password"
                    className="font-mono text-xs text-yellow hover:underline underline-offset-4 decoration-2">
                    FORGOT?
                  </Link>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-4 bg-yellow text-ink font-sans font-bold text-lg uppercase tracking-[0.05em] border-[3px] border-ink cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed transition-transform"
              ...
              {/* Register link */}
              <p className="text-center mt-8 font-mono text-sm text-[#979179]">
                Don't have an account?{' '}
                <Link to="/register" className="text-cyan font-bold hover:underline underline-offset-4 decoration-2">
                  REGISTER
                </Link>
              </p>
            </div>
